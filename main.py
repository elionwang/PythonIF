...
i = 1 # geef var i een waarde van 1 (identifier) 
...
aantalSteenSpeler = 0 # creëer variabele aantalSteenSpeler en geef een waarde van 0
aantalPapierSpeler = 0 # creëer variabele aantalPapierSpeler en geef een waarde van 0
aantalSchaarSpeler = 0 # creëer variabele aantalSchaarSpeler en geef een waarde van 0

aantalSteenComputer = 0 # creëer variabele aantalSteenComputer en geef een waarde van 0
aantalPapierComputer = 0 # creëer variabele aantalPapierComputer en geef een waarde van 0
aantalSchaarComputer = 0 # creëer variabele aantalSchaarComputer en geef een waarde van 0
...
while i <= matches: # maak while loop, voer code uit als i kleiner of gelijk is aan waarde van variabele 'matches'
  ...
  if spelerActie == computerActie: # check of spelerActie hetzelfde is als computerActie en voer code uit als dit klopt
    ...
    print(f'\x1b[1;34;40mPot {i}:\n\033[0mJij koos:',"\x1b[3;37;40m",f'{spelerActieNaam}',"\033[0m",'\nComputer koos:',"\x1b[3;37;40m",f'{computerActieNaam}',"\n\x1b[1;30;40m",'Het is gelijkspel!',"\n\x1b[1;30;42m",f'Jouw score: {spelerScore}\033[0m |',"\x1b[1;30;41m",f'Computer score: {computerScore}\033[0m') # geef uitslag en print naar console, gebruik ANSI escape codes voor alle kleuren
